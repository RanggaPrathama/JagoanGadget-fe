...
import { RowActions, AdminListHeader } from "@/components/admin";
...
export function NumberFormatListView() {
  ...
  return (
    <div className="space-y-5">
      <AdminListHeader
        title="Number Format Setup"
        description="Kelola urutan segmen penomoran dokumen."
      />
      ...
      <Tabs value={pathname}>
        <TabsList className="h-auto gap-1 rounded-full border border-border/60 bg-muted/60 p-1 shadow-sm">
          <TabsTrigger
            ...
            asChild
            className="rounded-full px-5 py-2 text-sm font-medium data-[state=active]:!bg-primary data-[state=active]:!text-primary-foreground dark:data-[state=active]:!bg-primary dark:data-[state=active]:!text-primary-foreground"
          >
