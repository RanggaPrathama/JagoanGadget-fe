...
// Re-export all role types so callers importing from this file keep working.
export type { RoleItem, RolePayload, RolePermissionEntry, RoleMenuEntry, RoleMenuPermission } from "../types";
